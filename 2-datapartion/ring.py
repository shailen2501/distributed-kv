...
class ConsistentHashRing:
    ...
    def get_node(self, key: str):
        ...
        # Get the index of this hash. As index returned by bisect could be out of bound of give hash
        # modulo opeorator bound it to the size of _keys structure and also makes the ring cicular
